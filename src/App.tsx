...
type UpdatePayload = { done: string; ongoing: string; next: string; challenges: string; progress: number; visibility: "رسمي مشترك" | "ملاحظة داخلية"; attachment?: string };
...
const roleProfiles: Record<RoleKey, { name: string; role: string; scope: string; initials: string }> = {
  ...
  branch: { name: "خالد الزهراني", role: "موظف الإدارة التنفيذية للفرع", scope: "فرع المنطقة الغربية فقط", initials: "خز" },
...
const initialWork: WorkItem[] = [
  { id: "REQ-2026-0212", title: "إعداد خطة تحسين إجراءات التشغيل في الفرع", type: "طلب", branch: "المنطقة الغربية", owner: "صندوق طلبات الفرع", status: "جديد", priority: "متوسطة", due: "26 أغسطس", description: "طلب وارد من مكتب وكيل الفروع إلى فرع المنطقة الغربية لإعداد خطة مختصرة تتضمن الوضع الحالي وفرص التحسين والجدول التنفيذي.", expectedResult: "خطة تحسين معتمدة تتضمن المسؤوليات والمواعيد.", category: "تحسين الإجراءات", requestScope: "مكتب وكيل الفروع", progress: 0, source: "مباشر", createdBy: "موظف مكتب وكيل الفروع", updates: [{ date: "الآن", author: "موظف مكتب وكيل الفروع", text: "تم إرسال الطلب إلى صندوق طلبات فرع المنطقة الغربية.", progress: 0, visibility: "رسمي مشترك" }] },
  { id: "REQ-2026-0211", title: "تزويد الفرع الغربي ببيانات تراخيص المشاريع المشتركة", type: "طلب", branch: "المنطقة الشرقية", originBranch: "المنطقة الغربية", owner: "صندوق طلبات الفرع", status: "بانتظار تحديث", priority: "عالية", due: "30 أغسطس", description: "طلب رسمي من فرع المنطقة الغربية إلى فرع المنطقة الشرقية للحصول على بيانات التراخيص المرتبطة بالمشاريع المشتركة.", expectedResult: "ملف موحد ببيانات التراخيص والملاحظات القائمة.", category: "طلب بيانات", requestScope: "بين الفروع", progress: 40, source: "مباشر", createdBy: "موظف الإدارة التنفيذية للفرع الغربي", updates: [{ date: "اليوم، 11:10 ص", author: "موظف الإدارة التنفيذية للفرع الشرقي", text: "تم جمع بيانات ثلاثة مشاريع وجارٍ استكمال مشروعين.", done: "جمع بيانات ثلاثة مشاريع.", ongoing: "استكمال بيانات مشروعين.", next: "مراجعة الملف وإرساله للفرع الغربي.", challenges: "انتظار إفادة إدارة المشاريع.", progress: 40, visibility: "رسمي مشترك" }, { date: "أمس، 9:00 ص", author: "موظف الإدارة التنفيذية للفرع الغربي", text: "تم إرسال الطلب إلى صندوق طلبات الفرع الشرقي.", progress: 0, visibility: "رسمي مشترك" }] },
  ...
  { id: "WI-2026-0138", title: "زيارة فريق أمانة جدة لمناقشة المسارات الخدمية", type: "زيارة", branch: "المنطقة الغربية", owner: "صندوق طلبات الفرع", status: "قيد الفرز", priority: "عاجلة", due: "26 أغسطس", description: "طلب زيارة مقدم من أمانة محافظة جدة يحتاج مراجعة الموعد وإسناده داخليًا.", progress: 0, source: "بوابة الجهات الخارجية", externalEntity: "أمانة محافظة جدة", attachment: "خطاب-طلب-الزيارة.pdf", updates: [{ date: "اليوم، 12:05 م", author: "بوابة الجهات الخارجية", text: "وصل الطلب إلى صندوق طلبات الفرع الغربي فقط.", progress: 0 }] },
  ...
  { id: "WI-2026-0134", title: "زيارة مواطن – اعتراض على إغلاق بلاغ", type: "زيارة", branch: "المنطقة الغربية", owner: "صندوق طلبات الفرع", status: "جديد", priority: "عالية", due: "27 أغسطس", description: "طلب زيارة جديد لا يظهر للموظفين؛ يراجعه موظف الإدارة التنفيذية للفرع ثم يسنده داخليًا.", progress: 0, source: "تكامل منصة الزيارات", citizen: { name: "سعد عبدالله المالكي", id: "10******19", mobile: "05*****422", purpose: "مراجعة إغلاق بلاغ قبل اكتمال المعالجة الميدانية", requestedDate: "الاثنين 31 أغسطس 2026 · 11:00 ص" }, updates: [{ date: "اليوم، 1:42 م", author: "تكامل منصة الزيارات", text: "تم استلام نموذج الزيارة وربطه بصندوق طلبات الفرع الغربي.", progress: 0 }] },
...
const initialUsers: PlatformUser[] = [
  ...
  { name: "خالد الزهراني", employee: "11834", role: "موظف الإدارة التنفيذية للفرع", scope: "المنطقة الغربية", team: "الإدارة التنفيذية للفرع", state: "نشط" },
  { name: "ريم الدوسري", employee: "11835", role: "موظف الإدارة التنفيذية للفرع", scope: "المنطقة الشرقية", team: "الإدارة التنفيذية للفرع", state: "نشط" },
  { name: "سارة القحطاني", employee: "11836", role: "موظف الإدارة التنفيذية للفرع", scope: "المنطقة الوسطى – الشمالية", team: "الإدارة التنفيذية للفرع", state: "نشط" },
  { name: "عبدالعزيز العسيري", employee: "11837", role: "موظف الإدارة التنفيذية للفرع", scope: "المنطقة الجنوبية", team: "الإدارة التنفيذية للفرع", state: "نشط" },
  { name: "مها الحربي", employee: "11838", role: "موظف الإدارة التنفيذية للفرع", scope: "المنطقة الشمالية الغربية", team: "الإدارة التنفيذية للفرع", state: "نشط" },
...
const viewTitles: Record<ViewKey, { title: string; subtitle: string }> = {
  ...
  transactions: { title: "معاملات تراسل", subtitle: "متابعة يدوية مستقلة لمعاملات تراسل دون تكامل آلي حاليًا" },
...
const roleGuidance: Record<RoleKey, { purpose: string; sees: string; action: string; level: "أساسي" | "مساند" }> = {
  center: { purpose: "يوجّه طلبات مكتب وكيل الفروع ويتابع التنفيذ المؤسسي.", sees: "طلبات الفروع المشتركة ومعاملات تراسل والتقارير ضمن جميع الفروع.", action: "ينشئ الطلبات ويسجل معاملات تراسل يدويًا ويطلب التحديث ويتابع الإغلاق.", level: "أساسي" },
...
function RequestsView({ items, role, onOpen }: { items: WorkItem[]; role: RoleKey; onOpen: (item: WorkItem) => void }) {
  ...
  return <>
    <section className="request-summary-grid">
      ...
      <article><span><Icon name="send"/></span><div><strong>{requests.filter((item) => item.requestScope === "بين الفروع" && item.originBranch === "المنطقة الغربية").length}</strong><small>صادرة لفروع أخرى</small></div></article>
...
function TransactionsView({ items, role: _role, onOpen }: { items: WorkItem[]; role: RoleKey; onOpen: (item: WorkItem) => void }) {
  ...
  return <>
    <section className="manual-integration-banner"><span><Icon name="file"/></span><div><strong>متابعة يدوية مؤقتة لمعاملات تراسل</strong><p>نظام تراسل هو المصدر الرسمي. التسجيل والحالة والتحديثات هنا للمتابعة الداخلية ولا تغيّر المعاملة الرسمية تلقائيًا.</p></div><b>لا يوجد تكامل حاليًا</b></section>
...
function CoordinatorInbox({ items, onOpen, onAssign }: { items: WorkItem[]; onOpen: (item: WorkItem) => void; onAssign: (item: WorkItem) => void }) {
  const pending = items.filter((item) => item.branch === "المنطقة الغربية" && item.owner === "صندوق طلبات الفرع" && (item.status === "جديد" || item.status === "قيد الفرز"));
...
function AccessMatrixView({ users, onAdd, onToggle }: { users: PlatformUser[]; onAdd: () => void; onToggle: (employee: string) => void }) {
  ...
  const templates = [
    ...
    { title: "المسؤول التنفيذي للفرع", count: "5", scope: "فرع واحد", sees: "لوحة الفرع وأعماله وتحديثاته وتقاريره", action: "اطلاع ومتابعة فقط دون إجراءات تشغيلية" },
    { title: "موظف مكتب وكيل الفروع", count: "6", scope: "جميع الفروع", sees: "الطلبات الموجهة للفروع ومعاملات تراسل وحالة التنفيذ", action: "إنشاء الطلب وتوجيهه وتسجيل تراسل يدويًا وطلب التحديث" },
  ...
  return <>
    <section className="access-kpis"><article><span><Icon name="users"/></span><div><small>إجمالي الموظفين</small><strong>500</strong></div></article><article><span><Icon name="shield"/></span><div><small>المسؤولون التنفيذيون للفروع</small><strong>5</strong></div></article><article><span><Icon name="briefcase"/></span><div><small>موظفو المكاتب التنفيذية</small><strong>36</strong></div></article><article><span><Icon name="user"/></span><div><small>منفذو العمل</small><strong>459</strong></div></article></section>
    ...
    <section className="panel audit-preview"><div className="panel-header"><div><h2>سجل الصلاحيات والتدقيق</h2><p>يحفظ النظام منفذ الإجراء والتاريخ والوقت والقيمة السابقة والجديدة.</p></div><span className="count-pill">غير قابل للحذف</span></div><div><article><Icon name="user" size={17}/><div><strong>تعديل نطاق مستخدم</strong><small>عبدالله الشهري · اليوم 11:42 ص · من الغربية إلى جميع الفروع</small></div></article><article><Icon name="shield" size={17}/><div><strong>إيقاف صلاحية مؤقتة</strong><small>عبدالله الشهري · أمس 2:10 م · انتهى التكليف</small></div></article></div></section>
  </>;
}
...
function CreateWorkModal({ onClose, kind: _kind, creatorRole, startTarasul = false, onSubmit }: { onClose: () => void; kind: "task" | "request"; creatorRole: RoleKey; startTarasul?: boolean; onSubmit: (item: WorkItem, draft: boolean) => void }) {
  ...
  const [branch, setBranch] = useState(branchMode && scope === "داخل الفرع" ? "المنطقة الغربية" : "");
  ...
  function save(draft: boolean) {
    const targetBranch = branchMode && scope === "داخل الفرع" ? "المنطقة الغربية" : branch;
    ...
    if (!draft && branchMode && scope === "بين الفروع" && targetBranch === "المنطقة الغربية") return setError("اختر فرعًا آخر مستلمًا للطلب.");
  ...
  return <ModalFrame title={titleText} eyebrow={manualTarasul ? "معاملات تراسل" : "طلب جديد"} description={descriptionText} onClose={onClose} footer={<><button className="ghost-button" onClick={onClose}>إلغاء</button><button className="secondary-button" onClick={() => save(true)}>حفظ كمسودة</button><button className="primary-button" onClick={() => save(false)}>{manualTarasul ? "تسجيل وإرسال للفرع" : "إنشاء وإرسال الطلب"} <Icon name="arrow" size={17}/></button></>}>
    {manualTarasul && <div className="manual-form-note"><Icon name="shield" size={18}/><div><strong>متابعة داخلية وليست تكاملًا مع تراسل</strong><p>حالة المنصة لا تغيّر حالة المعاملة الرسمية، ويمكن تحديث حالة تراسل يدويًا عند الحاجة.</p></div></div>}
    {branchMode && !manualTarasul && <fieldset className="method-fieldset"><legend>نطاق الطلب</legend><div className="method-grid"><label className={scope === "داخل الفرع" ? "selected" : ""}><input type="radio" name="scope" checked={scope === "داخل الفرع"} onChange={() => {setScope("داخل الفرع");setBranch("المنطقة الغربية");setError("")}}/><span className="method-icon"><Icon name="users"/></span><div><strong>داخل الفرع</strong><small>إلى إدارة أو موظف في فرعك</small></div><i/></label><label className={scope === "بين الفروع" ? "selected" : ""}><input type="radio" name="scope" checked={scope === "بين الفروع"} onChange={() => {setScope("بين الفروع");setBranch("");setError("")}}/><span className="method-icon blue"><Icon name="send"/></span><div><strong>إلى فرع آخر</strong><small>يصل إلى صندوق الفرع المستلم</small></div><i/></label></div></fieldset>}
    {manualTarasul && <div className="tarasul-box"><div className="section-label"><Icon name="file" size={18}/><strong>بيانات معاملة تراسل</strong><span>إدخال يدوي</span></div><div className="form-grid"><label>رقم معاملة تراسل<input value={transactionNo} onChange={(event) => setTransactionNo(event.target.value)} placeholder="مثال: 1447/3218"/></label><label>تاريخ المعاملة<input value={transactionDate} onChange={(event) => setTransactionDate(event.target.value)} type="date"/></label><label className="full">الجهة الواردة منها المعاملة<input value={entity} onChange={(event) => setEntity(event.target.value)} placeholder="اختياري حسب البيانات المتاحة"/></label></div></div>}
    <div className="form-grid main-form">
      ...
      <label>الفرع المستلم<select value={branchMode && scope === "داخل الفرع" ? "المنطقة الغربية" : branch} onChange={(event) => setBranch(event.target.value)} disabled={branchMode && scope === "داخل الفرع"}><option value="">اختر الفرع</option>{branchRows.map((item) => <option key={item.name} value={item.name} disabled={branchMode && scope === "بين الفروع" && item.name === "المنطقة الغربية"}>{item.name}</option>)}</select></label>
...
function WorkDetail({ item, role, onClose, onUpdate, onStatus, onStart, onAssign, onAction }: { item: WorkItem; role: RoleKey; onClose: () => void; onUpdate: (id: string, payload: UpdatePayload) => void; onStatus: (id: string, status: WorkStatus) => void; onStart: (item: WorkItem) => void; onAssign: (item: WorkItem) => void; onAction: (id: string, action: string, reason: string) => void }) {
  ...
  const isBranchPendingTask = role === "branch" && item.branch === "المنطقة الغربية" && item.type !== "زيارة" && item.owner === "صندوق طلبات الفرع" && (item.status === "جديد" || item.status === "مفتوحة" || item.status === "قيد الفرز") && !isSensitiveIntake;
  ...
  const canOperate = (role === "employee" && !isEmployeeAwaitingStart) || (role === "branch" && item.branch === "المنطقة الغربية" && !isSensitiveIntake && !isBranchPendingTask && !isWaitingForInternalAssignment);
  const isSendingBranchView = (role === "branch" || role === "owner") && item.requestScope === "بين الفروع" && item.originBranch === "المنطقة الغربية" && item.branch !== "المنطقة الغربية";
  ...
  return <div className="drawer-backdrop" onMouseDown={(e) => e.currentTarget === e.target && onClose()}>
    <aside className="detail-drawer" role="dialog" aria-modal="true">
      ...
      <div className="drawer-body">
        ...
        <section className="detail-section"><h3>سجل التحديثات</h3><div className="timeline">{visibleUpdates.map((u, i) => <div className="timeline-item" key={`${u.date}-${i}`}><i/><div><header><strong>{u.author}</strong><span>{u.date} · {u.progress}% · {u.visibility || "رسمي مشترك"}</span></header>{u.done || u.ongoing || u.next || u.challenges ? <div className="structured-update"><p><b>ما تم:</b> {u.done || "-"}</p><p><b>جاري العمل عليه:</b> {u.ongoing || "-"}</p><p><b>الخطوة القادمة:</b> {u.next || "-"}</p><p><b>التحديات:</b> {u.challenges || "لا يوجد"}</p></div> : <p>{u.text}</p>}</div></div>)}</div></section>
        {canOperate && !["مكتمل", "مغلق", "ملغى"].includes(item.status) && <section className="detail-section update-box"><div className="section-heading"><div><h3>إضافة تحديث موثق</h3><p>لا يقبل النظام تحديثًا فارغًا، ويحفظ كل تحديث باسم صاحبه وتاريخه.</p></div><span className="required-pill">حقول إلزامية</span></div><div className="update-form-grid"><label>ما تم<textarea value={done} onChange={(event) => setDone(event.target.value)} rows={2} placeholder="الأعمال المنجزة منذ آخر تحديث"/></label><label>ما يجري العمل عليه<textarea value={ongoing} onChange={(event) => setOngoing(event.target.value)} rows={2} placeholder="العمل الحالي مع التاريخ المتوقع"/></label><label>الخطوة القادمة<textarea value={next} onChange={(event) => setNext(event.target.value)} rows={2} placeholder="الإجراء التالي وموعده"/></label><label>التحديات<textarea value={challenges} onChange={(event) => setChallenges(event.target.value)} rows={2} placeholder="اكتب لا يوجد عند عدم وجود تحديات"/></label></div><div className="update-options"><label>نوع التحديث<select value={visibility} onChange={(event) => setVisibility(event.target.value as UpdatePayload["visibility"])}><option>رسمي مشترك</option><option>ملاحظة داخلية</option></select></label><label>مرفق داعم<input type="file" onChange={(event) => setAttachment(event.target.files?.[0]?.name || "")}/></label></div><label>نسبة الإنجاز <b>{progress}%</b><input type="range" min="0" max="100" step="5" value={progress} onChange={(e) => setProgress(Number(e.target.value))}/></label>{error && <small className="error-text">{error}</small>}<button className="primary-button" onClick={() => { if (!done.trim() || !ongoing.trim() || !next.trim() || !challenges.trim()) return setError("أكمل ما تم، وجاري العمل عليه، والخطوة القادمة، والتحديات."); onUpdate(item.id, {done, ongoing, next, challenges, progress, visibility, attachment: attachment || undefined}); setDone("");setOngoing("");setNext("");setChallenges("");setAttachment("");setError(""); }}>حفظ التحديث <Icon name="send" size={16}/></button></section>}
        {(role === "center" || role === "branch" || role === "employee") && <section className="detail-section action-composer"><h3>المزيد من الإجراءات</h3><div><select value={action} onChange={(event) => {setAction(event.target.value);setActionDate("");setActionCompleted("");setActionImpact("");setError("")}}><option value="">اختر الإجراء</option>{role === "center" && <><option>طلب تحديث</option><option>إغلاق</option><option>إعادة فتح</option><option>إلغاء</option></>}{role === "branch" && <><option>إعادة الإسناد</option><option>إشراك إدارة أخرى</option><option>نقل مسؤولية الطلب</option><option>طلب تحديث</option><option>تعليق الطلب</option><option>استئناف الطلب</option><option>طلب تمديد</option><option>إرسال للمراجعة</option></>}{role === "employee" && <><option>طلب تمديد</option><option>إرسال للمراجعة</option></>}</select><textarea value={reason} onChange={(event) => setReason(event.target.value)} rows={2} placeholder={action === "طلب تحديث" ? "اكتب التحديث المطلوب بوضوح..." : action === "تعليق الطلب" ? "اكتب سبب التعليق والعائق..." : action === "طلب تمديد" ? "اكتب سبب التمديد..." : action === "إعادة فتح" ? "اكتب سبب إعادة الفتح والمطلوب معالجته..." : "اكتب السبب أو المطلوب بوضوح..."}/>{["طلب تمديد", "تعليق الطلب", "إعادة فتح"].includes(action) && <label>التاريخ المقترح<input type="date" value={actionDate} onChange={(event) => setActionDate(event.target.value)}/></label>}{action === "طلب تمديد" && <><label>ما تم إنجازه<textarea value={actionCompleted} onChange={(event) => setActionCompleted(event.target.value)} rows={2}/></label><label>أثر عدم الموافقة<textarea value={actionImpact} onChange={(event) => setActionImpact(event.target.value)} rows={2}/></label></>}<button className="secondary-button" onClick={() => {if (!action || !reason.trim()) return setError("اختر الإجراء واكتب السبب أو المطلوب.");if (["طلب تمديد", "تعليق الطلب", "إعادة فتح"].includes(action) && !actionDate) return setError("حدد التاريخ المقترح لهذا الإجراء.");if (action === "طلب تمديد" && (!actionCompleted.trim() || !actionImpact.trim())) return setError("أكمل ما تم إنجازه وأثر عدم الموافقة على التمديد.");const details = action === "طلب تمديد" ? `${reason} · التاريخ الجديد المقترح: ${actionDate} · ما تم إنجازه: ${actionCompleted} · أثر عدم الموافقة: ${actionImpact}` : actionDate ? `${reason} · التاريخ المقترح: ${actionDate}` : reason;onAction(item.id, action, details);setAction("");setReason("");setActionDate("");setActionCompleted("");setActionImpact("");}}>تنفيذ الإجراء</button></div></section>}
      </div>
      <footer>
...
function AddUserModal({ onClose, onAdd }: { onClose: () => void; onAdd: (user: PlatformUser) => void }) {
  const [employee, setEmployee] = useState(""); const [role, setRole] = useState("منفذ العمل"); const [scope, setScope] = useState("المنطقة الغربية"); const [team, setTeam] = useState("فريق التنفيذ"); const [temporary, setTemporary] = useState(false); const [accessUntil, setAccessUntil] = useState(""); const [error, setError] = useState("");
...
export default function Home() {
  ...
  function createWork(item: WorkItem, draft: boolean) {
    ...
    notify(draft ? "تم حفظ السجل كمسودة." : startTarasul ? "تم تسجيل معاملة تراسل يدويًا وإرسالها للفرع." : "تم إنشاء الطلب وإرساله بنجاح.");
  }
  ...
  function updateWork(id: string, payload: UpdatePayload) { const text = `ما تم: ${payload.done} · جاري العمل عليه: ${payload.ongoing} · الخطوة القادمة: ${payload.next} · التحديات: ${payload.challenges}`; const nextStatus: WorkStatus = payload.progress === 100 ? "جاهز للتحقق" : "قيد التنفيذ"; const update = {date: "الآن", author: profile.name, text, ...payload}; setWorks((current) => current.map((w) => w.id === id ? {...w, progress: payload.progress, status: nextStatus, updates: [update, ...w.updates]} : w)); setSelected((current) => current?.id === id ? {...current, progress: payload.progress, status: nextStatus, updates: [update, ...current.updates]} : current); notify("تم حفظ التحديث وإدخاله تلقائيًا في التحديث الأسبوعي والشهري."); }
  ...
  function workTypeLabel(id: string, action: string) { const work = works.find((item) => item.id === id); return work?.type === "معاملة تراسل" && action === "إغلاق" ? "تم إغلاق المتابعة الداخلية فقط؛ حالة تراسل الرسمية لم تتغير، وحُفظ الإجراء في سجل التدقيق." : `تم تنفيذ «${action}» وحفظ السبب في سجل التدقيق.`; }
  ...
  const scopedWorks = role === "branch" ? works.filter((w) => w.branch === "المنطقة الغربية" || w.originBranch === "المنطقة الغربية") : role === "owner" ? works.filter((w) => (w.branch === "المنطقة الغربية" || w.originBranch === "المنطقة الغربية") && w.source !== "بوابة الجهات الخارجية" && w.source !== "تكامل منصة الزيارات") : role === "employee" ? works.filter((w) => w.owner === roleProfiles.employee.name) : role === "center" || role === "executive" ? works.filter((w) => w.source !== "بوابة الجهات الخارجية" && w.source !== "تكامل منصة الزيارات") : [];
